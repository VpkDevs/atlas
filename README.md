...
As of 2026-05-15, Atlas is at **v8.3** with 14 deterministic engines, Kernel/Router architecture, and Atlas-on-Atlas recursive self-evaluation. See [VERSION.md](VERSION.md) for canonical version history.
