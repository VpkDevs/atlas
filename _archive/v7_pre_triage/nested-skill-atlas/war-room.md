...
**Input:** `launch-day-summary.md`, all post-launch channels active, monitoring infrastructure live
...
Atlas writes `war-room-t12h-retro.md`:
...
Atlas writes `war-room-final-retro.md`:
...
Pre-scheduled posts continue firing per launch-sequence.md and content-calendar-30.md. Atlas verifies each fired correctly. If a scheduled post failed: Atlas reschedules it OR posts the fallback variant.
...
- [ ] `war-room-t12h-retro.md`, `war-room-final-retro.md` exist
