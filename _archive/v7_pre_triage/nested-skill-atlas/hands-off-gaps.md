...
**The launch assets gap:** Atlas creates text. The human still has to paste them in 6 different places. Better: Atlas creates a `launch-scripts.md` that is ordered sequentially — paste item 1, then item 2, etc. — so the human spends 15 minutes copy-pasting, not thinking.
...
Generate: launch-sequence.md — numbered steps in exact chronological order
