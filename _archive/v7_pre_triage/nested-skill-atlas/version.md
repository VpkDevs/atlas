...
```
┌─────────────────────────────────────────────────┐
│  atlas-kernel.md   (routing, single source)     │
│  ↓                                              │
...
- `docs/archive/fusion-router-v7.2-deprecated.md` — Replaced by atlas-kernel.md
...
- `how-to-run-atlas-on-atlas.md` — One-command launcher
...
2. **Wire engines incrementally.** See `improvement-guide.md` for the recommended week-by-week adoption order.
