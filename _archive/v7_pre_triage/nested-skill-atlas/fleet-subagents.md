...
**Standing Orders:**
- Execute weekly content cycle from `content-calendar-30.md`
...
- Update `tax-calendar.md` with upcoming deadlines
...
- Maintain `~/.atlas/portfolio/acquisition-pipeline.md`
