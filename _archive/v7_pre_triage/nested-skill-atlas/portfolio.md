...
- `your-next-move.md` — single most important action across the empire
...
- [ ] `your-next-move.md` contains exactly ONE action with specific reasoning
...
- ❌ your-next-move.md containing more than one action
