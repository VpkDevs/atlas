...
Format: `docs/founder/first-dollar-sprint.md`
...
First-Dollar Actions:
  → [N] personalized outreach messages ready in first-dollar-sprint.md
...
- `docs/founder/first-dollar-sprint.md` (if MRR = $0)
...
Atlas did:
  ...
  ✓ 10 personalized outreach messages written in first-dollar-sprint.md
  [Always:]
...
Human must do (non-blocking):
  → Send 10 outreach messages from first-dollar-sprint.md (~15 min)
...
- [ ] If MRR = $0: `docs/founder/first-dollar-sprint.md` exists with ≥ 10 personalized messages, each referencing the lead's specific post/complaint
...
- ❌ Using placeholders in first-dollar-sprint.md — every message must be send-ready
