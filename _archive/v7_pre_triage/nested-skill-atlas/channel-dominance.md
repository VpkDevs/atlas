...
- Allocation logged to `docs/founder/channel-allocation.md`
...
```text
Read capital_mode from atlas-brain.md
...
FREEZE rule (3-strike):
  ...
  Log freeze to atlas-brain.md: "[DATE] Froze [channel] — 3 cycles below floor"
...
GRADUATE rule:
  ...
  Log graduation to atlas-brain.md.
...
Write to `docs/founder/channel-allocation.md`:
