...
- Result written to `docs/founder/pricing-log.md`
...
```text
Read capital_mode from atlas-brain.md → current_capital_mode
...
**Baseline record (write to `docs/founder/pricing-log.md` before any change):**
...
3. If monetization_confidence_score > 70:
   ...
   → Note in atlas-brain.md: "Pricing systematized — lab on quarterly review"
```
