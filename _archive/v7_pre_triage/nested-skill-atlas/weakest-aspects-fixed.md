...
**Evidence:**
- "atlas-brain.md state machine" (described but not implemented)
...
# Output: startup-credits-applications.md with everything ready to copy-paste
```
