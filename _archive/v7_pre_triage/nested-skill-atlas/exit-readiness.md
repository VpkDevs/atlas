...
Create `docs/founder/data-room/` — the package any serious buyer needs:

```
docs/founder/data-room/
├── OVERVIEW.md           — executive summary (what it is, key metrics, why selling)
├── METRICS.md            — MRR, churn, MAU, CAC, LTV — last 12 months
├── tech-stack.md         — architecture, dependencies, scalability notes
...
Output top 5 in `docs/founder/data-room/ACQUIRERS.md`.
...
Output: `docs/founder/acquire-listing.md` — complete listing text, ready to paste.
...
- `docs/founder/data-room/` (complete — all 9 documents)
- `docs/founder/exit-readiness.md` (summary + valuation + ARS)
- `docs/founder/acquire-listing.md` (complete marketplace listing text)
...
Atlas did:
  ...
  ✓ Data room: 9 documents written in data-room/
...
Human must do (non-blocking):
  → Post to Acquire.com when ready — acquire-listing.md ready to paste
...
- [ ] `docs/founder/data-room/` committed with all required documents
...
- [ ] `docs/founder/acquire-listing.md` committed with paste-ready listing text
