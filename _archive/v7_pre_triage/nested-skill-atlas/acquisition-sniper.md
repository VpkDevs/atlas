...
- Result logged to `docs/founder/sniper-log.md` within 48 hours of deployment
...
Write to `docs/founder/sniper-log.md` within 48 hours:
...
`docs/founder/sniper-playbook.md` — Atlas maintains this file. Structure:
