---\nname: "strategic-architecture-v8.3"\ndescription: Atlas skill supplemental reference.\n---\n\n# Atlas v8.3 — Strategic Architecture Analysis

**Question 1:** What new gaps did we close vs. ideal-vs-actual.md?
...
| # | Gap from ideal-vs-actual.md | New Engine | What It Does |
|---|---------------------------|------------|--------------|
...
**atlas-kernel.md** (150 lines, always loaded):
